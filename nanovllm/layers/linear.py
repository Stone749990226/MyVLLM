...
class QKVParallelLinear(ColumnParallelLinear):
    def __init__(
        ...
        self.num_heads = divide(total_num_heads, tp_size)  # total_num_heads=16
        self.num_kv_heads = divide(total_num_kv_heads, tp_size)  # total_num_kv_heads=8
        output_size = (total_num_heads + 2 * total_num_kv_heads) * self.head_size
        super().__init__(hidden_size, output_size, bias)  # 1024, 4096, False
